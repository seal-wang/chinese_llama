...
1. **预训练模型**
   ...
   | 模型名称                                                        | 预训练语料                                                      | 下载地址                                                            |
   |-------------------------------------------------------------|------------------------------------------------------------|-----------------------------------------------------------------|
   | common base model                                       | 中文维基百科<br/>+百度百科<br/>     | [模型下载](https://pan.baidu.com/s/14hwHVvv_5YrIrJg2NWI62g) |
   | medaical base model                                       | 中文维基百科<br/>+百度百科<br/>+医学领域语料<br/> | [模型下载](https://pan.baidu.com/s/1slimqUbDsnChqFY3CsybVw) |
...
3. **模型测试**
   ...
   ```
	...
	8. 控制摄入量，避免过量食用高热量、高脂肪、高糖分的食物。
	9. 保持良好的睡眠质量，保证充足的睡眠时间。
	10. 定期进行身体检查，发现异常情况及时就医。
	11. 减少饮酒和吸烟对健康的影响，戒烟限酒。
	12. 定期进行体检，确保身体健康。
	13. 坚持锻炼，增强心肺功能和骨骼健康。
	14. 注意饮食卫生，避免暴饮暴食。
